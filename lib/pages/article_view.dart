...
import 'package:blazefeeds/widgets/actionbar.dart';
import 'package:blazefeeds/widgets/webview.dart';
    ...
    return Scaffold(
      ...
      body: PageView.builder(
        onPageChanged: ((int index) => {
              ...
              Provider.of<LatestArticleNotifier>(context, listen: false).updateValue(index),
            }),
